...
//CMAP
enum CmapSubEnum{
    Cmap0(   header:            CmapHeader
         ,   glyphIndexArray:   Array<GlyphIndex> );
    Cmap2(   header:            CmapHeader
         ,   glyphIndexArray:   Array<GlyphIndex>
         ,   subHeaderKeys:     Array<Int>
         ,   subHeaders:        Array<Int> );
    Cmap4(   header:            CmapHeader
         ,   glyphIndexArray:   Array<GlyphIndex> );
    Cmap6(   header:            CmapHeader
         ,   glyphIndexArray:   Array<GlyphIndex>
         ,   firstCode:         Int );
    Cmap8(   header:            CmapHeader
         ,   groups:            Array<CmapGroup>
         ,   is32:              Array<Int> );
    Cmap10(  header:            CmapHeader
          ,  glyphIndexArray:   Array<Int>
          ,  startCharCode:     Int
          ,  numChars:          Int );
    Cmap12(  header:            CmapHeader
          ,  groups:            Array<CmapGroup> );
    CmapUnk( header:            CmapHeader
           , bytes:             Bytes );
}
typedef CmapSubData = {
    cmapSubEnum: CmapSubEnum;
    
}
@:forward
abstract CmapSubTable( cmapSubData: CmapSubData ) to CmapSubData { 
    public
    function new( cmapSubData: CmapSubData  ){
        this = cmapSubData;
    }
    static inline function
    function read( bytes: Bytes, entry: CmapEntry ): CmapSubTable {
        ...
        var cmapHeader = { platformId:         entry.platformId
        ...
        if( cmapFormat == 0 ){
            ...
            input.readUInt16();
            for( i in 0...segCount ) startCodes.push(     input.readUInt16() );
            for( i in 0...segCount ) idDeltas.push(       input.readUInt16() );
            for( i in 0...segCount ) idRangeOffsets.push( input.readUInt16() );
            var count = Std.int((length - (8 * segCount + 16)) / 2);
            for( i in 0...count ) glyphIndices[ i ] = input.readUInt16();
            ...
            for( i in 0...segCount ){
                ...
                for( j in startCodes[ i ]...endCodes[i] + 1 ){
                    ...
                    var glyphIndex:GlyphIndex = { charCode: j
                                                , index:    index
    ...
    function mapCharCode( charCode:       Int
                        , glyphIndices:   Array<Int>
                        , segCount:       Int
                        , startCodes:     Array<Int>
                        , endCodes:       Array<Int>
                        , idRangeOffsets: Array<Int>
